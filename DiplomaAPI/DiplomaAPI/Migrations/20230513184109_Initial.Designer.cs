...
namespace DiplomaAPI.Migrations
{
    ...
    [Migration("20230513184109_Initial")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DiplomaAPI.Models.Appointment", b =>
                {
                    ...
                    b.Property<int?>("InpatientEpisodeEpisodeId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("InpatientEpisodeEpisodeId");
            ...
            modelBuilder.Entity("DiplomaAPI.Models.InpatientEpisode", b =>
                {
                    b.Property<int>("EpisodeId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<int>("HospitalizationDoctorId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("HospitalizationDoctorId");
            ...
            modelBuilder.Entity("DiplomaAPI.Models.MedicalCard", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<string>("CountryAndCode")
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("DirectedFrom")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("DiplomaAPI.Models.Referral", b =>
                {
                    ...
                    b.Property<int?>("HospitalizationDepartmentDepartmentId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("HospitalizationDepartmentDepartmentId");
            ...
            modelBuilder.Entity("DiplomaAPI.Models.Appointment", b =>
                {
                    ...
                    b.HasOne("DiplomaAPI.Models.InpatientEpisode", null)
                        .WithMany("Appointments")
                        .HasForeignKey("InpatientEpisodeEpisodeId");
            ...
            modelBuilder.Entity("DiplomaAPI.Models.InpatientEpisode", b =>
                {
                    ...
                    b.HasOne("DiplomaAPI.Models.Doctor", "HospitalizationDoctor")
                        .WithMany()
                        .HasForeignKey("HospitalizationDoctorId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                    ...
                    b.HasOne("DiplomaAPI.Models.MedicalCard", "MedicalCard")
                        .WithMany()
                    ...
                    b.HasOne("DiplomaAPI.Models.Doctor", "TreatingDoctor")
                        .WithMany()
                    ...
                    b.Navigation("HospitalizationDoctor");
            ...
            modelBuilder.Entity("DiplomaAPI.Models.Referral", b =>
                {
                    ...
                    b.HasOne("DiplomaAPI.Models.Department", "HospitalizationDepartment")
                        .WithMany()
                        .HasForeignKey("HospitalizationDepartmentDepartmentId");
                    ...
                    b.Navigation("HospitalizationDepartment");
